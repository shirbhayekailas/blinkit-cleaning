      ...
      <div className="p-4 sm:p-5 border-t border-slate-100 dark:border-slate-700/60 bg-slate-50/50 dark:bg-slate-800/50 space-y-3">
        ...
        <div className="grid grid-cols-3 gap-2 pt-1">
          ...
          <button
            ...
            className={`px-2.5 py-2 rounded-xl text-xs font-bold transition flex items-center justify-center gap-1 ${
              isReceived
          ...
          >
            ...
            <span>{isReceived ? 'Payment Info' : 'Update Pay'}</span>
          </button>

          {/* PDF Report Button */}
          <button
            onClick={() => onGeneratePDF(cleaning)}
            className="px-2.5 py-2 rounded-xl text-xs font-bold bg-slate-100 hover:bg-slate-200 dark:bg-slate-700 dark:hover:bg-slate-650 text-slate-700 dark:text-slate-200 transition flex items-center justify-center gap-1"
          >
          ...
          <button
            ...
            className="px-2.5 py-2 rounded-xl text-xs font-bold bg-green-50 hover:bg-green-100 dark:bg-green-950/40 text-green-700 dark:text-green-300 border border-green-200 dark:border-green-900 transition flex items-center justify-center gap-1"
          >
